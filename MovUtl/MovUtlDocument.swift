    ...
    override func data(ofType typeName: String) throws -> Data {
        ...
        for i in 0..<layerViews.count {
            ...
            for object in layer.objects! {
                ...
                data.append("FirstColorR:\(object.firstColor.components?[0]);".data(using: .utf8)!)
                data.append("FirstColorG:\(object.firstColor.components?[1]);".data(using: .utf8)!)
                data.append("FirstColorB:\(object.firstColor.components?[2]);".data(using: .utf8)!)
                data.append("SecondColorR:\(object.secondColor.components?[0]);".data(using: .utf8)!)
                data.append("SecondColorG:\(object.secondColor.components?[1]);".data(using: .utf8)!)
                data.append("SecondColorB:\(object.secondColor.components?[2]);".data(using: .utf8)!)
